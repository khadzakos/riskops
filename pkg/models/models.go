...
type Position struct {
	...
	CurrentPrice  float64   `json:"current_price"`  // latest market price converted to portfolio currency (0 if unavailable)
	PriceCurrency string    `json:"price_currency"` // original currency of the price before conversion (e.g. "USD", "RUB")
	UpdatedAt     time.Time `json:"updated_at"`
}
