...
= ПРИЛОЖЕНИЕ. ОПИСАНИЕ ПРИМЕНЕНИЯ ГЕНЕРАТИВНОЙ МОДЕЛИ
<appendix-ai>
#set heading(numbering: none)

== Цели применения модели

Целью применения генеративных моделей при выполнении курсовой работы было приведение текста программной документации к единому стилю и устранение стилистических, грамматических и пунктуационных ошибок, а также документирование программного кода проекта.
...
- ChatGPT (модель GPT-4o): #link("https://chatgpt.com/");
- Qwen (модель Qwen2.5-VL-32B-Instruct): #link("https://huggingface.co/spaces/Qwen/Qwen2.5-VL-32B-Instruct").
